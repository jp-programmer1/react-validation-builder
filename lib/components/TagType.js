...
const TagType = ({ styles, data, onChange, classNameField }) => {
    ...
    return (react_1.default.createElement("div", { className: "validation-builder-tag-type" },
        ...
        activeEdit &&
            react_1.default.createElement("div", { onBlur: () => setActiveEdit(false) },
                react_1.default.createElement(Index_1.SelectCustom, { name: "type", onChange: handleChange, options: utils_1.optionsType, value: data.type, className: classNameField }))));
};
