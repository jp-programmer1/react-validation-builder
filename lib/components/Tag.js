    ...
    return (react_1.default.createElement("div", { className: "validation-builder-badge-container" },
        react_1.default.createElement(react_1.default.Fragment, null, copyData && copyData.value &&
            react_1.default.createElement("div", { className: "validation-builder-badge validation-builder-grid", style: Object.assign({}, styles) },
                ...
                react_1.default.createElement("div", { onClick: () => onRemove(copyData[namekey]), style: Object.assign({}, config.removeTag && config.removeTag.styles) }, (config === null || config === void 0 ? void 0 : config.removeTag) ?
...
const Message = ({ data, config }) => (react_1.default.createElement("div", { className: "validation-builder-item-message", style: Object.assign({ opacity: data.value && data.value.message && data.value.message !== "" ? 1 : 0.60 }, config && config.message && config.message.styles) }, config && config.message ?
    ...
    : react_1.default.createElement("div", { className: 'validation-builder-item-custom-message' }, "m")));
const NumberComponent = ({ value, config }) => (react_1.default.createElement("div", { className: "validation-builder-item-action", style: Object.assign({}, config && config.valueNumberTag && config.valueNumberTag.styles) }, config && config.valueNumberTag ?
    react_1.default.createElement(react_1.default.Fragment, null,
...
const StringComponent = ({ value, config }) => (react_1.default.createElement("div", { className: 'validation-builder-item-tag-string', style: Object.assign({ opacity: value && value !== "" ? 1 : 0.60 }, config && config.valueStringTag && config.valueStringTag.styles) }, config && config.valueStringTag ?
    ...
    : react_1.default.createElement("div", { className: 'validation-builder-item-custom-string' }, "s")));
const DateComponent = ({ value, config }) => (react_1.default.createElement("div", { className: 'validation-builder-item-tag-string', style: Object.assign({ opacity: value && value !== "" ? 1 : 0.60 }, config && config.valueDateTag && config.valueDateTag.styles) }, config && config.valueDateTag ?
    ...
    : react_1.default.createElement("div", { className: 'validation-builder-item-custom-date' }, "date")));
exports.default = Tag;
