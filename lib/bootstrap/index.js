        ...
        react_1.default.createElement("div", { className: "validate-editor-container-button-add" },
            react_1.default.createElement("button", { type: "button", style: (_a = config === null || config === void 0 ? void 0 : config.addField) === null || _a === void 0 ? void 0 : _a.styles, className: "btn btn-primary btn-sm", onClick: onAddField }, (config === null || config === void 0 ? void 0 : config.addField) ?
                ...
                : react_1.default.createElement("div", null,
                    ...
                    " Add"))),
        fields && fields.map((field, key) => (react_1.default.createElement("div", { className: "row mb-3", key: key },
            react_1.default.createElement("div", { className: "col-sm-3 d-flex", style: { marginTop: 5, alignItems: 'baseline' } },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(Index_1.InputCustom, { type: "text", placeholder: "Name Field", value: fieldKeys[key], className: "form-control", activateFocus: (fieldKeys.length - 1) === key, onBlur: () => {
