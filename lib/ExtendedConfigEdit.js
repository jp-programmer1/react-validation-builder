            ...
            react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement("div", { className: "row align-items-center mb-2" },
                    ...
                    react_1.default.createElement("div", { className: "col-sm-4" },
                        react_1.default.createElement(Index_1.InputCustom, { type: "number", name: "minLength", value: values.minLength, onChange: (value) => onChangeCallback(value, "minLength") })),
                    react_1.default.createElement("div", { className: "col-sm-2 t-l" },
                        react_1.default.createElement("label", { htmlFor: "maxLength" }, "Max Lenght")),
                    react_1.default.createElement("div", { className: "col-sm-4" },
                        react_1.default.createElement(Index_1.InputCustom, { type: "number", name: "maxLength", value: values.maxLength, onChange: (value) => onChangeCallback(value, "maxLength") }))),
                react_1.default.createElement("div", { className: "row align-items-center mb-2" },
                    react_1.default.createElement("div", { className: "col-sm-2 t-l" },
        ...
        values.type === 'number' || values.type === "integer" &&
            react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { className: "row align-items-center mb-2" },
                    ...
                    react_1.default.createElement("div", { className: "col-sm-4" },
                        react_1.default.createElement(Index_1.InputCustom, { type: "number", name: "minimum", value: values.minimum, onChange: (value) => onChangeCallback(value, "minimum") })),
                    react_1.default.createElement("div", { className: "col-sm-2 t-l" },
                        react_1.default.createElement("label", { htmlFor: "maximum" }, "Max")),
                    react_1.default.createElement("div", { className: "col-sm-4" },
                        react_1.default.createElement(Index_1.InputCustom, { type: "number", name: "maximum", value: values.maximum, onChange: (value) => onChangeCallback(value, "maximum") }))),
                react_1.default.createElement("div", { className: "row align-items-center mb-2" },
